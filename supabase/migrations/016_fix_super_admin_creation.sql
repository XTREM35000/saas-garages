-- Migration pour corriger la création du Super-Admin
-- Problème : Erreur 500 lors de la création du Super-Admin

-- 1. Vérifier et créer la table super_admins si elle n'existe pas
...
GRANT USAGE ON SEQUENCE public.super_admins_id_seq TO anon;
GRANT USAGE ON SEQUENCE public.super_admins_id_seq TO authenticated;
