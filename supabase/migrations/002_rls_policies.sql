-- Migration 002: RLS Policies et Configuration Auth
...
-- 15. Fonction pour mettre à jour la dernière connexion
...
-- 16. Trigger pour mettre à jour la dernière connexion
...
-- 17. Créer un utilisateur admin par défaut (mot de passe: admin123)
-- Note: Ceci doit être fait via l'interface Supabase ou via une Edge Function
-- car nous ne pouvons pas insérer directement dans auth.users

-- 18. Fonction pour obtenir les statistiques du dashboard
...
-- 19. Fonction pour rechercher des clients
...
-- 20. Fonction pour obtenir l'historique des interventions d'un véhicule
...
-- 21. Index supplémentaires pour optimiser les performances
...
-- 22. Vues pour simplifier les requêtes courantes
