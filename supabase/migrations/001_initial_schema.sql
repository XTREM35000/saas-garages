-- Schéma initial pour Garage Abidjan Dashboard
...
CREATE INDEX idx_interventions_vehicule_id ON interventions(vehicule_id);
...
CREATE INDEX idx_medias_categorie ON medias(categorie);
...
-- Données de test pour les médias (GIFs)
