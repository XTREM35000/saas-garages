-- Migration pour créer la fonction RPC create_super_admin_complete
-- Cette fonction permet de créer un Super Admin complet en une seule fois
-- Elle peuple automatiquement les 4 tables : auth.users, public.users, public.profiles, public.super_admins

-- Créer la fonction RPC create_super_admin_complete
...
BEGIN
  ...
  -- Insert into public.users (optionnel)
  INSERT INTO public.users (
    ...
    v_user_id,
    COALESCE(p_avatar_url, 'public/avatar01.png'),
    p_email,
    p_name,
    p_phone,
    'super_admin',
