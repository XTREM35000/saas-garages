-- Migration corrigée avec ordre de création approprié
-- Création des tables dans l'ordre pour éviter les erreurs de références
...
CREATE TABLE IF NOT EXISTS users (
    ...
    role VARCHAR(50) DEFAULT 'employe' CHECK (role IN ('admin', 'manager', 'technicien', 'employe')),
