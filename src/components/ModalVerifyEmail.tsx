...
export const ModalVerifyEmail: React.FC<ModalVerifyEmailProps> = ({
  isOpen,
  onClose,
  onVerifySuccess,
  email,
  ...
  const handleVerify = async () => {
    ...
    try {
      // Simuler la vérification OTP (à implémenter avec votre backend)
      ...
      if (otpString === '123456') {
        setIsVerified(true);
        toast.success('Code email vérifié ! 📧');
